    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-krafton-yellow uppercase tracking-widest">Admin Dashboard</h1>
          <button 
            onClick={handleLogout}
            className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded text-sm font-bold uppercase tracking-wider transition-colors"
          >
            <LogOut size={16} />
            Logout
          </button>
          ...
          <div className="bg-gray-900 border border-white/10 p-6 rounded-lg">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold">{registrations.filter(r => !r['Paid Entry']).length}</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-gray-900 border border-white/10 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative animate-fade-in">
            <div className="sticky top-0 bg-gray-900 border-b border-white/10 p-6 flex justify-between items-center z-10">
              <h2 className="text-2xl font-bold text-krafton-yellow uppercase tracking-wider">Registration Details</h2>
              <button 
